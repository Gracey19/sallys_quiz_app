  ...
  return (
    <div className="relative w-full min-h-screen">
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-6 px-8 mt-12 pb-12">

          <Link to="/gutentag">
            <img
              src="/images/place_holders/Guten_Tag.svg"
              alt="Guten Tag Placeholder"
              className="w-full h-auto drop-shadow-sm cursor-pointer hover:scale-105 transition-transform duration-200 dark:brightness-110"
            />
          </Link>
          ...
          <img
            ...
            className="w-full h-auto drop-shadow-sm hover:scale-105 transition-transform duration-200 dark:brightness-110"
          />

          <img
            src="/images/place_holders/Einkauf.svg"
            alt="Einkauf Placeholder"
            className="w-full h-auto drop-shadow hover:scale-105 transition-transform duration-200 dark:brightness-110"
          />
